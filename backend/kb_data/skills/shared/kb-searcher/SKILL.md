...
1. Search the KB index to find relevant documents.
2. Read the full content of matching files.
3. Summarize the relevant information clearly and concisely.
4. Always cite the source file path so the user can find it later.
